...
const Register = () => {
    ...
    return (
        <section id="register" className={`flex md:flex-row flex-col ${styles.paddingX} pt-12`}>
            <div className={`flex-1 flex ${styles.marginX} md:my-0 my-10 relative`}>
                <img src={heroml3} alt="login-icon" className="w-[100%] h-[100%] relative z-[5]" />
                {/* gradient start */}
            ...
            <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
                ...
                <form onSubmit={handleLogin}>
                    ...
                    <button type="submit" className="gap-x-10 font-poppins font-semibold text-[18px] text-primary bg-blue-gradient px-4 py-2 rounded-md mt-2">Sign up</button>
                </form>
            </div>
        </section>
